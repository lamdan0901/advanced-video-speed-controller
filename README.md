...
- **Show top-right controller outside fullscreen on this site**: Keeps the floating speed controller visible even when not in fullscreen mode for the current domain only
